 ...
 * Author: Ammar Khazaa
 ******************************************************************************/
/*unit test being sure this module is working by itself*/
/*integration test for soe modules*/
/*compiler if not founde prototype compil error
linker did not found defenation */
#ifndef DET_H
#define DET_H
...
/*in case to file working togother*/
