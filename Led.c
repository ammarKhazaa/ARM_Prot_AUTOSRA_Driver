 ...
 ******************************************************************************/
#include "Port.h"
#include "Dio.h"        /*write & read 3n tarrek dio*/
#include "Led.h"
...
{
    /*take value  put it in state rewrite it */
...
{
    /*call fun. Dio_FlipChannel and give him no. of DioConf_LED1_CHANNEL_ID_INDEX fun. return value but i will not do with it any thing*/
